...
namespace Uszoverseny2
{
    public partial class EredmenyForm : Form
    {
        ...
        {
            lblCim.Text = tav + " méteres " + uszasNem + " eredmenye: ";
        ...
        private void lstVersenyzok_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                txtIdoEredemeny.Text = new DateTime(versenyzo.IdoEredmeny.Ticks).ToString("mm:ss");
            }
            catch (Exception)
            {
        ...
        private void rdBtnEredmeny_CheckedChanged(object sender, EventArgs e)
        {
            ...
            foreach (Versenyzo versenyo in versenyzok)
            {
                lstVersenyzok.Items.Add(versenyo);
            }
        }
